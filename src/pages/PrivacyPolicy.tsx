    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-16 max-w-4xl mt-16">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-sm text-gray-600 mb-8 text-center">Last updated: April 18, 2025</p>
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li className="mb-2">
              <strong>Application</strong> refers to scleral lens smart mirror, the software program
              provided by the Company.
            </li>
            <li className="mb-2">
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
              Agreement) refers to arify.net, www.arify.net.
            </li>
            <li className="mb-2">
          ...
          <h3 className="text-xl font-medium mt-6 mb-3">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6 mb-3">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6 mb-3">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-medium mt-6 mb-3">Disclosure of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-medium mt-6 mb-3">Security of Your Personal Data</h3>
          <p>
          ...
          <ul className="list-disc ml-6 mb-4">
            <li>By email: privacy@arify.net</li>
          </ul>
          
          <div className="mt-8 text-center">
            <Link to="/" className="text-brand-blue hover:text-brand-darkBlue transition-colors">
              Return to Home
            </Link>
          </div>
        </div>
